...
from app.services import appointment_service, catalog_service, client_service, employee_service, notification_service, waitlist_service
...
async def _notification_count(session: AsyncSession, tenant_id: uuid.UUID, appointment_id, notification_type) -> int:
